...
class Widget:
    ...
    def show(self):
        from Scripts.Main import screen
...
class Button(Widget):
    ...
    def Touched(self):
        from Scripts.Main import Eventos
...
class Text:
    ...
    retro24 = pygame.font.Font("../Recursos/Fuentes/retro.ttf", 24)
    retro16 = pygame.font.Font("../Recursos/Fuentes/retro.ttf", 16)
    rad24 = pygame.font.Font("../Recursos/Fuentes/Radicales.otf", 24)
    ...
    defaultFont = pygame.font.Font(None,24)
