...
class Pregunta():
    def __init__(self, num):
        txtf = open("../Recursos/Texto/Preguntas.csv", newline='')
        ...
        2- Intervalos xeR a []/
        3- Intervalos [] a xeR/
        4- Números Qué tipo de número es el 5/
        5- Números Los números naturales comprenden/
        6- Cuál es la propiedad incorrecta/
        7- Extrae/
        8- Introduce/
        9- Resuelve/
        10- Suma de polinomios/
        11- Resta de polinomios/
        12- Multiplicación de polinomios/
        13- Qué método usarías para resolver está división/
        14- Cuáles podrían ser las raíces de este polinomio/
        15- Es x raíz de este polinomio/
        16- Extraer factor común
        ...
        for i in range(4):
            ...
            if self.csvData[c[1]] == "0":
                self.Respuestas.append(Respuesta(Text((190, 230+i*80), Text.Fpreguntas, self.csvData[c[0]], (252, 148, 3)), self.csvData[c[2]]))
            else:
                self.Respuestas.append(Respuesta(Text((190, 230+i*80), Text.Fpreguntas, self.csvData[c[0]], (252, 148, 3)), self.csvData[c[2]]))
